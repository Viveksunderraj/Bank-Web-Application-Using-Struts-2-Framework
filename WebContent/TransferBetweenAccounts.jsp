...
%>  
	<form action="transferBetweenAccounts" method="post">
	<div>
	...
	<div class="row">
		...
		<div class="col-6">
			<select name="ToAccountnumber" id="toAccountList">
				<c:forEach items="${accounts}" var="account"> 
					<option value="${account.getAccountNumber()}" data-accNo="${account.getAccountNumber()}">${account.getAccountNumber()}-${account.getAccountName()} (${account.getBranchName()})</option><br><br>
				</c:forEach>
			</select>
		</div>
	</div>
