		...
		<div class="col-6">
			<select name="Accountnumber" id="accountList">
				<c:forEach items="${accounts}" var="account"> 
					<option value="${account.getAccountNumber()}" id="${account.getAccountBalance()}" data-accType="${account.getAccountType()}" data-minBalance="${account.getMinimumBalance()}">${account.getAccountNumber()}-${account.getAccountName()} (${account.getBranchName()})</option><br><br>
				</c:forEach>
			</select>
		</div>
	</div>
